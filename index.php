...
<html lang="zxx">
    <head>
        ...
        <title>Axton - Multipurpose Personal Portfolio HTML Template</title>
    ...
    <body id="home" data-spy="scroll" data-offset="70">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="light-index-2.html">
        ...
        <div class="main-banner main-banner-two bg-light">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="banner-img">
                            <img src="assets/img/woman.jpg" data-tilt alt="image">
        ...
        <section class="featured-services-area bg-light">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-featured-services-box light">
                            <div class="icon">
        ...
        <div class="separate bg-light">
            <div class="br-line"></div>
        </div>

        <!-- Start About Area -->
        <section id="about" class="about-area ptb-80 bg-light">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12">
                            <div class="about-content">
                                ...
                                <h3>Skills</h3>
                                <div class="bar"></div>
                                <p>We provide marketing services to startups and small businesses to looking for a partner of their digital media, design & development, lead generation and communications requirements.</p>
                            </div>
                        </div>
                            ...
                            <div class="skills-list">
                                <div class="skill-item">
									<div class="skill-header">
										<h4 class="skill-title">SEO, SEM & SMM</h4>
								...
								<div class="skill-item">
									<div class="skill-header">
										<h4 class="skill-title">Content Writing</h4>
								...
								<div class="skill-item">
									<div class="skill-header">
										<h4 class="skill-title">Affiliate Marketing</h4>
                                ...
                                <div class="skill-item">
									<div class="skill-header">
										<h4 class="skill-title">Keyword Research</h4>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="about-content">
                                ...
                                <div class="btn-box">
                                    ...
                                    <a href="#" class="default-btn white-color-btn">Download CV</a>
                                </div>
                            </div>
                        </div>
        ...
        <section id="services" class="services-area ptb-80">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            <div class="icon">
                                <i class="flaticon-puzzle"></i>
                            </div>
                            <h3><a href="single-services.html">Digital Branding</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            ...
                            <h3><a href="single-services.html">Creative Solutions</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            ...
                            <h3><a href="single-services.html">Marketing Solutions</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            ...
                            <h3><a href="single-services.html">Business Analytics</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            ...
                            <h3><a href="single-services.html">UX & UI Design</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-services-box light">
                            ...
                            <h3><a href="single-services.html">Photography</a></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore.</p>
                            <a href="single-services.html" class="details-btn"><i class="flaticon-right-arrow"></i></a>
                        </div>
                    </div>
        ...
        <!-- Start Projects Area -->
        <section id="projects" class="projects-area ptb-80 bg-light">
            <div class="container">
                <div class="section-title light">
            ...
            <div class="projects-slides owl-carousel owl-theme">
                <div class="single-projects-box light">
                    <a href="#"><img src="assets/img/projects/1.jpg" alt="img"></a>

                    <div class="projects-content">
                        <h3><a href="single-projects.html">Development</a></h3>
                        <span>Web / Mobile</span>
                    </div>
                </div>

                <div class="single-projects-box light">
                    <a href="#"><img src="assets/img/projects/2.jpg" alt="img"></a>

                    <div class="projects-content light">
                        <h3><a href="single-projects.html">Architecture</a></h3>
                        <span>Home / Bridge</span>
                    </div>
                </div>

                <div class="single-projects-box light">
                    <a href="#"><img src="assets/img/projects/3.jpg" alt="img"></a>

                    <div class="projects-content">
                        <h3><a href="single-projects.html">UX/UI Design</a></h3>
                        <span>Web / Mobile</span>
                    </div>
                </div>

                <div class="single-projects-box light">
                    <a href="#"><img src="assets/img/projects/4.jpg" alt="img"></a>

                    <div class="projects-content">
                        <h3><a href="single-projects.html">Marketing</a></h3>
                        <span>Digital / Affiliate</span>
                    </div>
                </div>

                <div class="single-projects-box light">
                    <a href="#"><img src="assets/img/projects/5.jpg" alt="img"></a>

                    <div class="projects-content">
                        <h3><a href="single-projects.html">Photography</a></h3>
        ...
        <section id="client" class="testimonials-area ptb-80 bg-light">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                    ...
                    <div class="col-lg-6 col-md-12">
                        ...
                        <div class="testimonials-slides light owl-carousel owl-theme">
                            <div class="single-testimonials-item light">
        ...
        <!-- Start Partner Area -->
        <div class="partner-area bg-light">
            <div class="container">
        ...
        <!-- Start Team Area -->
        <section id="team" class="team-area ptb-80 bg-light">
            <div class="container">
                <div class="section-title light">
                ...
                <div class="team-slides owl-carousel owl-theme">
                    <div class="single-team-box light">
        ...
        <section class="subscribe-area ptb-80 subscribe-bg-light">
            <div class="container">
        ...
        <!-- Start Blog Area -->
        <section id="blog" class="blog-area ptb-80 bg-light">
            <div class="container">
                <div class="section-title light">
                    <span>Our Blog</span>
                    <h2>Latest News</h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-post light">
        ...
        <!-- Start Contact Area -->
        <section id="contact" class="contact-area ptb-80 bg-light">
            <div class="container">
                <div class="section-title light">
        ...
        <!-- Start Footer Area -->
        <footer class="footer-area bg-f9f9f9">
            <div class="container">
                <div class="footer-content">
                    <div class="logo">
                        <a href="light-index-2.html"><img src="assets/img/logo-black.png" alt="image"></a>
                        <p>Lorem ipsum dolor consectetur adipiscing elit, eiusmod tempor ut labore et dolore magna aliqua.</p>

                        <ul class="footer-contact-info">
                            <li>Email: <a href="#">info@axton.com</a></li>
                            <li>Phone: <a href="#">+44 478 857 7458</a></li>
                        </ul>
            ...
            <div class="footer-shape1"><img src="assets/img/shape3.png" alt="image"></div>
            <div class="footer-shape2"><img src="assets/img/shape4.png" alt="image"></div>
        </footer>
        <!-- End Footer Area -->
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6">
                        <p><i class="far fa-copyright"></i> EnvyTheme. All Rights Reserved, 2019</p>
                    </div>
